...
class PlayingPageState extends State<PlayingPage> {
  Color pageColor = musicplayer.randomColor
      .randomColor(colorBrightness: ColorBrightness.custom(Range(80, 83)));
  bool isFavorited;
  ...
  void initAudioPlayer() {
    ...
    _audioPlayerStateSubscription =
      ...
      if (s == AudioPlayerState.PLAYING) {
        ...
        try {
          musicplayer
              .play(musicplayer.queueFileList[musicplayer.currTrack + 1]);
        } catch (e) {}
          ...
          if (musicplayer.currTrack != musicplayer.queueFileList.length - 1) {
            ...
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => PlayingPage(
                      ...
                      fileMetaData: musicplayer
                                  .queueMetaData[musicplayer.currTrack][0] !=
                              null
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                                child: ListTile(
                                  ...
                                  trailing: Text(
                                      "${playlistTracks[index].length} Tracks"),
                                  onTap: () {
                    ...
                    Row(
                      ...
                      children: <Widget>[
                            ...
                            if (musicplayer.currTrack != 0) {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      PlayingPage(
                                        filePath: musicplayer.queueFileList[
                                            musicplayer.currTrack],
                                        fileMetaData: musicplayer.queueMetaData[
                                                    musicplayer.currTrack][0] !=
                                                null
                                            ? musicplayer.queueMetaData[
                                                musicplayer.currTrack]
                                            : [
                                                musicplayer.queueFileList[
                                                    musicplayer.currTrack],
                                                "unknown"
                                              ],
                                        backPage: widget.backPage,
                        ...
                        IconButton(
                          ...
                          tooltip: "Next Track",
                          onPressed: () {
                            if (musicplayer.currTrack !=
                                musicplayer.queueFileList.length - 1) {
                              musicplayer.currTrack++;
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      PlayingPage(
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        musicplayer.duration == null
                            ? Container()
                            : Slider(
                                value: musicplayer.position?.inMilliseconds
                                        ?.toDouble() ??
                                    0.0,
                                ...
                                min: 0.0,
                                max: musicplayer.duration.inMilliseconds
                                    .toDouble()),
                        Wrap(
